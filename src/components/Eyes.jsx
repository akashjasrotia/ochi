...
export default function Eyes() {
  ...
  return (
    <div className="w-full h-screen overflow-hidden">
      <div className='relative z-1 w-full h-full bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")]'>
        <div className="w-[30vw] z-10 h-[12vw] absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] flex justify-between">
